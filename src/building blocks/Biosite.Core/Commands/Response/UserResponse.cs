...
namespace Biosite.Core.Commands.Response
{
    public class UserResponse : ICommandResult
    {
        ...
        public UserResponse(Guid id, string name, string email, double weight, double height, Gender gender, DateTime birthdate, DateTime lastLoginDate, bool isPregnant = false)
        {
            Id = id;
            Name = name;
            Email = email;
